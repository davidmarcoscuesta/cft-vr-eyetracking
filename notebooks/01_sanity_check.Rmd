...
# Existencia, dimensiones y columnas clave
```{r}
...
```
# Estructura temporal (monotonía y dt)
```{r}
...
# Proyección al plano: rangos y NA
```{r}
...
# Invalid y invalidWindow (parpadeos + padding)
```{r}
...
# Velocidades: distribución y outliers
```{r}
...
# Consistencia de IDs entre ETdata_clean e Interpdata
